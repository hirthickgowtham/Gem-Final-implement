 ...
 * @param {import("stream").Readable | Buffer} streamOrBuffer - The readable stream to upload
...
const UploadStreamMediaFilesAws = async (file_type, file_name, streamOrBuffer) => {
    try {
        ...
        console.error("Error in UploadStreamMediaFilesAws in KafkaConsumer:", error);
        throw error;
    }
};
